...
const LOCAL_GUEST_USER: Session['user'] = {
  id: 'delta-local-user',
  username: 'Naxx',
...
export function HomePageContent({
  ...
  const effectiveUser = user || LOCAL_GUEST_USER
  ...
  // If effective user exists, don't block
  const isAuthRequired = !effectiveUser && process.env.NEXT_PUBLIC_ENABLE_LOCAL_AUTH !== 'true'
