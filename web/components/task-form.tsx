...
const AGENT_MODELS = {
  ...
  opencode: [
    { value: 'AntigravityCombo', label: '9Router / AntigravityCombo' },
    { value: 'KiloCombo', label: '9Router / KiloCombo' },
    { value: 'Delta', label: '9Router / Delta' },
    { value: 'ag/gemini-3.8-flash-high', label: '9Router / Gemini 3.8 Flash' },
    { value: 'ag/claude-sonnet-4-6', label: '9Router / Claude Sonnet 4.6' },
    { value: 'openrouter/deepseek/deepseek-v4-pro-0813', label: '9Router / DeepSeek V4 Pro' },
    { value: 'gpt-5', label: 'GPT-5' },
...
const getOpenCodeRequiredKeys = (model: string): Provider[] => {
  if (!model) return []
  // 9Router local models do not require remote vendor API keys
  if (
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4">Delta AI Coding Agent</h1>
